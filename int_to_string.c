...
/**
 * get_int - gets a charater pointer to new string containing int
 * @num: numer to convert to string
 *
 * Return: charater pointer to newly created string. NULL if malloc fails.
 */
char *get_int(int num)
{
	unsigned int temp;
 ...
 *
 * Return: unsigned integned abs  rep of i
 */
 ...
 * @buff_size of a buffer in bytes
 *
 * Return: always void.
 */
void fill_numbase_buff(unsigned int num, unsigned int base,
